# 6a. Design a HTML form that displays Text boxes to indicate the 3 items purchased 
# and the cost of each item. Validate the entry on server-side using Python to ensure 
# that data entered in the text boxes are appropriate. In case of any errors, display 
# appropriate messages on the web page. Else , calculate the total amount to be paid
#  by the customer  using Python on server-side and display the result.
