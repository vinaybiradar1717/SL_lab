# 12b. Python and JavaScript - ATM Application: Design a HTML form that displays user’s current balance, 
# an input field to enter amount and buttons to withdraw or deposit money. Validate the form such that 
# negative amount cannot be entered and Users cannot withdraw more than 5000 at one time.
#  The maximum number of transactions is 5.
