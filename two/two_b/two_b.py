# 2b. a) Load the ‘Student Performance’ dataset into one of the data structures (NumPy or Pandas).
...
# 	e) Perform the following visualization on the loaded dataset: Tally of the Number of Male & Female students who took up the 
#     ‘test preparation  course’ and those who did not.
...
ax = sns.countplot(x="test preparation course",hue='gender',palette='Set2',data=stuperf_df)
