# 4b. Python and JavaScript - Shopping Cart Application: Design a simple Shopping Cart 4
# application which allows users to add items to their cart from a list of products.
#  Allow users to view their cart (items and quantities of each) .
